"""
Seed the stocks table with all S&P 500 Tier-1 symbols (~503 entries).

The S&P 500 contains 503 ticker lines because some companies have two
share classes listed (Alphabet A/C, Fox A/B, News Corp A/B).

Sector names follow the GICS standard as published on Wikipedia's
"List of S&P 500 companies" page (fetched 2026-06-15).
...
TIER1_STOCKS: list[tuple[str, str, str]] = [
    # (symbol, name, sector)
    # Source: Wikipedia "List of S&P 500 companies" — 2026-06-15
    ("MMM",   "3M",                                          "Industrials"),
    ...
    ("EL",    "Estee Lauder Companies (The)",                "Consumer Staples"),
